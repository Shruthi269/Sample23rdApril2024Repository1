...
public class ModifyCustomer
{
	...
	private static void modifyCustomer()
	{
		try 
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("(//textarea[@class='textarea'])[1]")).click();
			Thread.sleep(2000);
			
			oBrowser.findElement(By.xpath("(//textarea[@class='textarea'])[1]")).sendKeys("Small Business");
			oBrowser.findElement(By.xpath("(//div[@class='closeButton'])[7]")).click();			//Edit window Close Button
			Thread.sleep(2000);
